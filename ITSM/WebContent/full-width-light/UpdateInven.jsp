			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h5 class="txt-dark">Update Inventory</h5>
					</div>
					<!-- 						Breadcrumb
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Update Inventory</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form action="../UpdateInvenServlet" method="post">
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												<label class="control-label mb-10">IP Switch</label> <input
													type="text" class="form-control" name="ipswitch"
													placeholder="IP switch" required>
											</div>
											<br>
											<div class="form-group ml-15">
												<button type="submit" class="btn btn-success"
													name="buttoncheck" value="1">
