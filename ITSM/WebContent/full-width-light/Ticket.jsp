					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Create Ticket</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form action="../InsertTicketServlet" method="post">
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												<label class="control-label mb-10 text-left">SLA</label><br>
												<select class="form-control" name="sla">
													<option value="" selected disabled hidden>Choose SLA Here...</option>
											...
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												...
												EAR NO
												</label> <input type="text" class="form-control" name="earno" required>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												<label class="control-label mb-10 text-left">
												Hostname
												</label> <input type="text" class="form-control" name="hostname" required>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												<label class="control-label mb-10 text-left">
												IP
												</label> <input type="text" class="form-control" name="ip" required>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
