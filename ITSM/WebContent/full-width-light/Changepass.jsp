												...
												<form action="../EditUser" method="post"
													...
													<div class="form-body">
														<h6 class="txt-dark capitalize-font">
															<i class="zmdi zmdi-account mr-10"></i>Change Password
														</h6>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">Old
																		Password:</label>
																	<div class="col-md-9">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">New
																		Password:</label>
																	<div class="col-md-9">
																		<input type="password" class="form-control"
																			name="newpass" id="password" required>
																	</div>
																</div>
															</div>
															<!--/span-->
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">Retry
																		Password:</label>
																	<div class="col-md-9">
																		<input type="password" class="form-control"
																...
																<div class="col-md-6">
																	<div class="row">
																		<div class="col-md-offset-3 col-md-9">
																			<button type="submit" value="2" name="buttoncheck"
